...
ckpt_name=hallu_pref_lang_trans_eq_0_1_0_1
ckpt_save_path=${ckpt_save_dir}/${ckpt_name}
mkdir -p ${ckpt_save_path}
# Data paths
hallucination_data=/mnt/petrelfs/songmingyang/songmingyang/runs/llava/preprocess/sft_on_palo_1000/desc_dpo_data/loss/hallucination
language_data=/mnt/petrelfs/songmingyang/songmingyang/runs/llava/preprocess/sft_on_palo_1000/desc_dpo_data/loss/language
preference_data=/mnt/petrelfs/songmingyang/songmingyang/runs/llava/preprocess/sft_on_palo_1000/desc_dpo_data/loss/preference
translation_data=/mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/hadpo-data/hadpo/llava-v1.5/multilingual
