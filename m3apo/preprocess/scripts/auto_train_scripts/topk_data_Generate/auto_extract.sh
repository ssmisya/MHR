...
do
    ...
    do
        ...
        do
            ...
            bash /mnt/petrelfs/songmingyang/code/mm/MAPO/m3apo/preprocess/scripts/srun_extract_dpo_data.sh ${language} ${strategy} ${select_k} 1>${log_path}/extract_${strategy}_${language}_${select_k}.log 2>&1 &
            sleep 1
        done
    done
done