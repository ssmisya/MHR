language_dict = {
    ...
    'fa':{'full_name':'Persian','yes':'بله','no':'نه','prompt_suffix':' لطفاً پاسخ خود را از ({},{}). انتخاب کنید و مطمئن شوید که پاسخ شما شامل هیچ کلمه دیگری نیست.'},
    'el':{'full_name':'Greek','yes':'ναι','no':'όχι','prompt_suffix':' Παρακαλώ επιλέξτε την απάντησή σας από ({},{}). Και βεβαιωθείτε ότι η απάντησή σας δεν περιέχει καμία άλλη λέξη.'},
    'uk':{'full_name':'Ukrainian','yes':'так','no':'ні','prompt_suffix':' Будь ласка, виберіть свою відповідь з ({},{}). І переконайтеся, що ваша відповідь не містить жодного іншого слова.'},
