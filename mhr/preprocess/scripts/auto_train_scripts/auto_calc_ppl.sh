...
do
    ...
    do
        ...
        bash /mnt/petrelfs/songmingyang/code/mm/MAPO/mhr/preprocess/scripts/srun_desc_calc_bleu.sh ${language} ${srategy} 1>${log_path}/calc_bleu_${srategy}_${language}.log 2>&1 &
        sleep 1
    done
done