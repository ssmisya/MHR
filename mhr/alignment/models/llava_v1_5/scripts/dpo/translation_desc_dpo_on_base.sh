...
ckpt_name=translation_desc_dpo_on_base
ckpt_save_path=${ckpt_save_dir}/${ckpt_name}
mkdir -p ${ckpt_save_path}
# Data paths
hallucination_data=/mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/hadpo-data/hadpo/llava-v1.5/multilingual
...
accelerate launch --config_file=${accelerate_config_file}  ./train_dpo.py \
    ...
    --hallucination_data_type "dir_of_json_desc" \
